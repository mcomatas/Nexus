        ...
        <div>
            ...
            {game.artworks && 
                <div className="flex flex-col h-100 items-center relative">
                    <Image src={'https:' + game.artworks[Math.floor(Math.random() * game.artworks.length)].url.replace('t_thumb', 't_1080p')} alt={slug} layout="fill" style={{ objectFit: 'cover', objectPosition: 'center 20%' }} quality={100}/>
